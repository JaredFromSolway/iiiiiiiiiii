(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [218], {
        54131: function(t, e, r) {
            var i = r(67133).Buffer,
                n = r(25566);
            ! function() {
                var e, a, o, f, s, h, d, c = {
                        7160: function(t, e, r) {
                                ...
                                switch (M) {
                                    ...
                                    case "PRIVATE KEY":
                                        switch (g = (_ = i.PrivateKey.decode(S, "der")).algorithm.algorithm.join(".")) {
                                            ...
                                            case "1.2.840.10045.2.1":
                                                return {
                                                    curve: _.algorithm.curve, privateKey: i.ECPrivateKey.decode(_.subjectPrivateKey, "der").privateKey
                                                };
                                            case "1.2.840.10040.4.1":
                                    ...
                                    case "DSA PRIVATE KEY":
                                        return {
                                            type: "dsa", params: i.DSAPrivateKey.decode(S, "der")
                                        };
                                    case "EC PRIVATE KEY":
                                        return {
                                            curve: (S = i.ECPrivateKey.decode(S, "der")).parameters.value, privateKey: S.privateKey
                                        };
                                    default:
                                        throw Error("unknown key type " + M)
                                }
